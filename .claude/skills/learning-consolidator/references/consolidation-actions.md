...
| A Python-specific pattern with code example | Relevant reference skill, or `AGENTS.md` → Conventions |
| An architecture pattern with directory structure | Relevant reference skill, or `AGENTS.md` → Conventions |
