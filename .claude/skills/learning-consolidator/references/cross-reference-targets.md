...
|----------------|---------------|
| Python coding convention | Relevant reference skill (if one exists), `.cursor/rules/code-quality.md` |
| Architecture convention | Relevant reference skill (if one exists), `.cursor/rules/feature-development.md` |
| Testing convention | `.cursor/rules/testing.md`, `tests/conventions.md` |
