...
| Quantified | Includes at least one number: cost, frequency, percentage, or count. "40% of assessments run with PARTIAL_DATA" beats "wastes compute resources." |
...
| Quality | Criterion |
|---------|-----------|
| Specific | Names the exact thing excluded, not a vague category. "Map layer toggle during assessment" not "other UI changes." |
