...
All new components must follow the project's architecture conventions documented in
`AGENTS.md`. If a reference skill exists for the project's module layout, use it as
the canonical template.

Key constraints (adapt to this project's structure):
