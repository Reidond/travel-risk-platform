...
### 2.1. Публічна демонстрація (без встановлення)

Публічний демонстраційний екземпляр платформи доступний за адресою **<https://travel-risk-platform.andrii-shafar.workers.dev>**.

> **Зауваження щодо збереження даних:** база даних демонстраційного екземпляра є тимчасовою — вона очищується після ~30 хвилин простою, після кожного нового розгортання та під час технічного обслуговування хостингу. Якщо дані зникли, просто натисніть **«Завантажити демо-набір»** на сторінці **«Регіони та дані»** ще раз. Для постійного збереження даних запустіть платформу самостійно через Docker (підрозділ 2.2).

### 2.2. Запуск через Docker (рекомендовано для постійних даних)
